...
const ListItem = ({ advice }) => {
	...
	return (
		<div
			...
			className='gap-2 p-1 pl-6 transition ease-in-out border-l-2 border-r-2 border-stone-50 rounded-xl md:grid md:grid-cols-8 hover:divide-x hover:divide-stone-300 hover:border-stone-300'
		>
